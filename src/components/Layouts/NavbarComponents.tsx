...
import AutoCompleteSearchComponents from './AutocompleteSearchComponents';
                    ...
                    <ul
                        ...
                        {navigation.map((item: any) => (
                            <li key={item.name} className='max-lg:border-b max-lg:py-3 px-3'>
                                <a href={item.href}
                                    className='lg:hover:text-[#007bff] text-[#007bff] block font-semibold text-[15px]'>{item.name}</a>
                            </li>
                        ))}
                    </ul>
                </div>
