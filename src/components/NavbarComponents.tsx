...
export default function NavbarComponents() {
    ...
    return (
        <header className='shadow-md font-[sans-serif] tracking-wide z-50 sticky top-0 '>
            <section
            ...
            <div  id="collapseMenu"
                ...
                <button id="toggleClose" className='lg:hidden fixed top-2 right-4 z-[100] rounded-full bg-red-700 p-3'>
 ...
 <ul className='lg:flex lg:flex-wrap lg:items-center lg:justify-center px-10 py-3 bg-[#333] min-h-[46px] gap-4 max-lg:space-y-4 max-lg:fixed max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50 border-b-8'>
                    {navigation.map((item) => (
