                ...
                <div className="grid lg:grid-cols-3 gap-6">
                    <div className="lg:col-span-2 max-lg:order-1 p-6 !pr-0 max-w-4xl mx-auto w-full">
                        <div className="text-center max-lg:hidden">
                            <h2 className="text-3xl font-extrabold text-gray-800 inline-block border-b border-gray-800 pb-1">Checkout</h2>
                        </div>
                        ...
                        <form className="lg:mt-16">
                            ...
                            <div className="flex flex-wrap gap-4 mt-8">
                                ...
                                <button type="button" className="min-w-[150px] px-6 py-3.5 text-sm bg-gray-800 text-white rounded-lg hover:bg-gray-900">Confirm payment $240</button>
                            </div>
                        </form>
                    </div>
